...
TOOL_REGISTRY: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": "theHIVE built-in AI-powered vulnerability analysis. Uses Gemini to analyze scan results and prioritize findings.",
        "category": "AI Ops",
        "severity": "info",
        "requires_confirmation": False,
        "os_support": ["linux", "windows", "android"],
        "install_commands": {"linux": "# Built into theHIVE", "windows": "# Built into theHIVE", "android": "# Built into theHIVE"},
        ...
        "command_templates": {
            "linux": "# Analyzed by theHIVE Agent Brain via Gemini API",
            "windows": "# Analyzed by theHIVE Agent Brain via Gemini API",
            "android": "# Analyzed by theHIVE Agent Brain via Gemini API"
        },
        "estimated_duration": 30,
    ...
    },
    {
        ...
        "description": "theHIVE built-in natural language to command converter. Describe what you want in plain English.",
        "category": "AI Ops",
        "severity": "info",
        "requires_confirmation": False,
        "os_support": ["linux", "windows", "android"],
        ...
        "command_templates": {
            "linux": "# Generated by theHIVE Agent Brain via Gemini API",
            "windows": "# Generated by theHIVE Agent Brain via Gemini API",
            "android": "# Generated by theHIVE Agent Brain via Gemini API"
        },
        "estimated_duration": 5,
